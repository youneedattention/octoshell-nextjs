  ...
  zh: [
    {
      group: "🚗 車輛及車內守則",
      items: [
        { q: "預訂後會派發什麼樣的車輛？", a: "本公司專注於高端禮賓包車服務，旗下車隊僅由豪華商務車 「豐田埃爾法（最大載客5人）」 及大容量商旅車 「豐田海獅（最大載客9人）」 組成。我們不提供普通轎車車型。" },
        ...
        { q: "團隊行程中，車輛可以幫我們單獨將行李運送到酒店嗎？", a: "可以，這正是我們高爾夫球團和徒步登山團的核心特色服務。我們可以先將您送至高爾夫球場或登山起點，隨後由專屬車輛將您的行李（如高爾夫球包、重型登山包等）先行送往您今晚入住的酒店並辦理寄存，讓您全程輕鬆出行。需要注意的是，基於日本法規，我們僅提供本團簽約客人的隨行行李分流運送，不接受無乘客隨行的純商業貨運。" },
        { q: "司機會穿著正式、配戴領帶嗎？", a: "是的，我們的司機始終穿著正式的西裝並配戴領帶，保持最高標準的專業儀表。" },
        { q: "司機會保護乘客的隱私和保密性嗎？", a: "是的。保護您的隱私和機密是我們的重中之重。我們的司機遵循最嚴格的保密標準，確保您的私密對話和行程信息在任何時候都絕對安全。" },
        { q: "可以在車內給手機充電嗎？", a: "可以。我們的車輛均配有充電接口，並免費提供兼容蘋果和安卓設備的車載充電線。" },
      ],
    },
    {
      group: "💴 費用與支付相關",
      items: [
        ...
        { q: "萬一乘客在行程中臨時需要修改路線或增加用車時間怎麼辦？", a: "請立即與司機溝通，司機會馬上與調度中心取得聯繫並確認追加費用。因乘客臨時變更路線或超時而全新產生的高速公路費、收費道路費、回送通行費、停車場費、司機住宿費以及時間延長溢價費用，將據實累加至您的最終賬單中。由於我們的包車服務均為提前排單預約制，請諒解當天的實際預約情況可能會有無法滿足您臨時需求的情況發生。" },
        { q: "過路費、停車費、燃油費及所有相關費用都包含在報價內嗎？", a: "是的。一個價格包含一切——過路費、停車費、燃油費及司機住宿費（跨夜行程）。無任何隱藏收費。唯一可能產生追加費用的情況，是行程開始後您要求更改路線。" },
        { q: "兒童安全座椅和機場舉牌接機怎麼收費？", a: "完全免費（0日元）。我們免費提供兒童安全座椅/嬰兒座椅，並免費提供到達大廳舉牌接機服務。為了便利提前調度，請在預訂時儘早向客服提出申請。" },
        { q: "支付方式是什麼？可以在車內直接付款給司機嗎？", a: "我們支持車內現金結帳，也可以在行程前綁定信用卡，行程結束後通過我們的線上支付系統（藍條支付）自動完成扣款。如企業法人客戶確無信用卡，可申請提前進行銀行轉帳。" },
        { q: "行程結束後是否有發票或收據？", a: "有。使用信用卡支付的客戶，在行程結束扣款完成後，系統會自動將合規的電子收據（格式為PDF電子領收書）發送至您註冊的電子郵箱。使用現金結帳的客戶，我們將根據您的需求，在行程結束後提供電子收據或請款單。" },
      ],
    },
    {
      group: "❌ 取消政策",
...
const EXTRA_ITEMS: { g: 0|1|2|3|4|5; q: Record<Lang,string>; a: Record<Lang,string> }[] = [
  { g: 0, q: { en: "Do your drivers speak English?", ja: "乗務員は英語を話せますか？", zh: "司機會說英語嗎？" }, a: { en: "Yes. All bookings are fully supported in English. Our drivers have working English for day-to-day communication. For complex conversations we use translation tools to assist.", ja: "はい。すべての予約は英語で対応しております。乗務員は日常会話程度の英語を使用できます。複雑なご要望の際は翻訳ツールを活用してサポートいたします。", zh: "是的。我們全程提供英文預訂支援。司機具備日常英語溝通能力，如有複雜需求，亦會借助翻譯工具協助。" } },
  { g: 0, q: { en: "Do you operate 24/7?", ja: "24時間対応していますか？", zh: "是否24小時服務？" }, a: { en: "Yes. We operate around the clock with no late-night or early-morning surcharge. All prices are the same regardless of departure time.", ja: "はい。24時間365日対応しており、深夜・早朝の割増料金は一切ございません。出発時間に関わらず料金は同一です。", zh: "是的。我們全年無休、24小時服務，深夜及清晨均無附加費用，價格不因時段而改變。" } },
  { g: 2, q: { en: "How much luggage can I bring?", ja: "荷物はどのくらい積めますか？", zh: "可以帶多少行李？" }, a: { en: "Alphard: up to 4 passengers and 4 large suitcases. Hiace: up to 9 passengers and 6+ large suitcases. Please declare your exact luggage count when booking. Oversized items — golf bags, strollers, ski equipment — must be mentioned in advance.", ja: "アルファード：最大4名様・大型スーツケース4個。ハイエース：最大9名様・大型スーツケース6個以上。ご予約時に荷物の数を必ずお知らせください。ゴルフバッグ・ベビーカー・スキー用品などの大型荷物は必ず事前にお申し出ください。", zh: "埃爾法：最多4人及4件大型行李箱。海獅：最多9人及6件以上大型行李箱。預訂時請告知確切行李數量。高爾夫球包、嬰兒車、滑雪器材等特大行李必須提前說明。" } },
  { g: 2, q: { en: "Do you accommodate wheelchair users?", ja: "車椅子の方も利用できますか？", zh: "可以乘坐輪椅嗎？" }, a: { en: "Yes. Please notify us at booking with the wheelchair type (foldable / electric / dimensions) so we can assign a suitable vehicle.", ja: "はい。ご予約の際に車椅子の種類（折りたたみ式・電動式・サイズ）をお知らせいただければ、適切な車両をご用意いたします。", zh: "可以。預訂時請告知輪椅類型（折疊式／電動式／尺寸），以便我們安排合適的車輛。" } },
  { g: 3, q: { en: "Can I request multiple stops?", ja: "複数の立ち寄り先を追加できますか？", zh: "可以安排多個停靠點嗎？" }, a: { en: "Yes. Please list all stops in advance when booking. Additional charges may apply depending on routing.", ja: "はい。ご予約時に全ての立ち寄り先をご記入ください。ルートによっては追加料金が発生する場合があります。", zh: "可以。請在預訂時列明所有停靠地點。視乎路線，可能需要支付額外費用。" } },
  { g: 3, q: { en: "Do you offer hourly charter?", ja: "時間制貸切はできますか？", zh: "可以按小時包車嗎？" }, a: { en: "Yes. Minimum 4 hours. Ideal for shopping, corporate meetings, and sightseeing. Book in advance — same-day bookings are not guaranteed.", ja: "はい。最低4時間からご利用いただけます。ショッピング・企業訪問・観光に最適です。事前予約推奨。当日ご予約はご対応できない場合があります。", zh: "是的。最少4小時起。適合購物、商務拜訪及觀光。建議提前預訂，當天預約未必有車。" } },
  { g: 4, q: { en: "Where exactly will the driver meet me?", ja: "空港でどこで待っていてもらえますか？", zh: "司機在機場哪裡等候？" }, a: { en: "In the arrivals hall, after customs and baggage claim. Your chauffeur will be holding a name board with your name. Please do not exit the terminal before finding your driver.", ja: "到着ロビー（入国審査・手荷物受け取り後）にてお待ちしております。乗務員がお客様のお名前を掲げたネームプレートをお持ちしております。ドライバーを見つける前に建物の外へ出ないようご注意ください。", zh: "在到達大廳（通關及取行李後）等候。司機將手持寫有您姓名的接機牌。請在找到司機前勿離開航站樓。" } },
  { g: 4, q: { en: "How long does it take from Narita Airport to Tokyo?", ja: "成田空港から東京市内まで何分かかりますか？", zh: "從成田機場到東京市區需要多久？" }, a: { en: "Typically 50–70 minutes. Allow up to 90 minutes during peak hours or if there is an accident on the expressway.", ja: "通常50〜70分程度です。ラッシュアワー時や高速道路での事故発生時は、最大90分ほどお見込みください。", zh: "通常約50至70分鐘。尖峰時段或高速公路發生事故時，請預留最多90分鐘。" } },
  { g: 4, q: { en: "How long does it take from Haneda Airport to Tokyo?", ja: "羽田空港から東京市内まで何分かかりますか？", zh: "從羽田機場到東京市區需要多久？" }, a: { en: "Typically 30–45 minutes. Allow up to 60 minutes during heavy traffic.", ja: "通常30〜45分程度です。交通渋滞時は最大60分ほどお見込みください。", zh: "通常約30至45分鐘。交通繁忙時請預留最多60分鐘。" } },
  { g: 4, q: { en: "How long will the driver wait after landing?", ja: "着陸後どのくらい待ってもらえますか？", zh: "落地後司機會等多久？" }, a: { en: "Your chauffeur waits in the arrivals hall until you appear. We track your flight in real time, so they know exactly when you land. You have 90 minutes after touchdown to clear customs and collect your bags — take your time.", ja: "乗務員は到着ロビーでお客様が現れるまでお待ちしております。フライトをリアルタイムで追跡しているため、着陸時間は把握済みです。通関・手荷物受け取りには着陸後90分間ゆっくりお使いください。", zh: "司機在到達大廳等您出現。我們即時追蹤您的航班，因此完全掌握您的落地時間。落地後有90分鐘讓您完成通關及取行李，請從容不迫。" } },
  { g: 4, q: { en: "Should I exchange my JR Pass at the airport?", ja: "JRパスは空港で交換すべきですか？", zh: "我應該在機場兌換JR Pass嗎？" }, a: { en: "We recommend exchanging at major Tokyo stations (Tokyo, Shinjuku, Shibuya) where queues are minimal. Airport counters can have 1–2 hour waits. Your driver can take you to a station counter after drop-off if needed.", ja: "東京・新宿・渋谷など都内の主要駅での交換をお勧めします。空港のカウンターは1〜2時間待ちになる場合があります。ご希望であれば、お送りの後に駅のカウンターへご案内することも可能です。", zh: "建議在東京、新宿、澀谷等主要車站兌換，等候時間極短。機場兌換窗口可能需排隊1至2小時。若有需要，司機可在送達後帶您前往車站窗口。" } },
  { g: 5, q: { en: "Do you pick up from hotels, private residences, or Airbnb?", ja: "ホテルや個人宅・Airbnbへの送迎はできますか？", zh: "可以從酒店、民宅或Airbnb接送嗎？" }, a: { en: "Yes. We pick up from any address in Tokyo and surrounding areas — hotels, private homes, Airbnb, offices, or any location you specify.", ja: "はい。東京都内および近郊であれば、ホテル・個人宅・Airbnb・オフィス等、ご指定のいかなる場所からでも対応いたします。", zh: "是的。東京市內及周邊地區任何地址均可，包括酒店、私人住宅、Airbnb、辦公室等您指定的地點。" } },
  { g: 5, q: { en: "Do you serve Yokohama cruise terminals?", ja: "横浜のクルーズターミナルも対応していますか？", zh: "可以接送橫濱郵輪碼頭嗎？" }, a: { en: "Yes. We serve Osanbashi Pier and Daikoku Pier. Please include your vessel name and arrival/departure time when booking.", ja: "はい。大さん橋ふ頭および大黒ふ頭に対応しております。ご予約の際は船名と入出港時間をお知らせください。", zh: "是的。我們服務大棧橋碼頭及大黑碼頭。預訂時請提供船名及到港/離港時間。" } },
  { g: 5, q: { en: "Do you go to Tokyo Disney Resort?", ja: "東京ディズニーリゾートへの送迎はできますか？", zh: "可以接送東京迪士尼樂園嗎？" }, a: { en: "Yes. Both Tokyo Disneyland and Tokyo DisneySea entrances.", ja: "はい。東京ディズニーランド・東京ディズニーシーの両入口に対応しております。", zh: "是的。東京迪士尼樂園及東京迪士尼海洋均可接送。" } },
  { g: 5, q: { en: "Do you provide long-distance transfers across Japan?", ja: "日本全国への長距離送迎はできますか？", zh: "可以提供日本全國長途接送嗎？" }, a: { en: "Yes. We operate across Japan — Mt. Fuji, Hakone, Nikko, Karuizawa, ski resorts in Nagano and Niigata, and beyond. Contact us for a quote on any destination.", ja: "はい。富士山・箱根・日光・軽井沢・長野や新潟のスキーリゾートなど、日本全国に対応しております。ご希望の目的地へのお見積もりはお気軽にお問い合わせください。", zh: "是的。我們覆蓋全日本，包括富士山、箱根、日光、輕井澤、長野及新潟滑雪勝地等。任何目的地均可詢價。" } },
  { g: 5, q: { en: "What if I leave something in the car?", ja: "車内に忘れ物をした場合は？", zh: "如果在車上遺留物品怎麼辦？" }, a: { en: "Contact us immediately at info@octoshell.jp. If the item is found, we will arrange return delivery. Shipping costs are at the client's expense.", ja: "速やかにinfo@octoshell.jpまでご連絡ください。お忘れ物が見つかり次第、ご返送の手配をいたします。送料はお客様のご負担となります。", zh: "請立即聯絡 info@octoshell.jp。若找到遺失物，我們將為您安排寄回。郵寄費用由客人承擔。" } },
  { g: 1, q: { en: "Is tipping required?", ja: "チップは必要ですか？", zh: "需要給小費嗎？" }, a: { en: "No. Tipping is not customary in Japan and is never expected by our chauffeurs. A kind word or an online review is the best way to show your appreciation.", ja: "不要です。チップは日本では一般的な慣習ではなく、乗務員が期待することもございません。温かいお言葉やオンラインレビューが最大の励みになります。", zh: "不需要。日本沒有給小費的習慣，我們的司機也從不期待。若您滿意服務，留下評價或一句好評是最好的回饋。" } },
];
