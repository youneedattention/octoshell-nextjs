...
const ALPHARD = "/images/alphard.png";
const HIACE   = "/images/hiace.png";
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <div className="flex items-center justify-center gap-4">
              <span className="text-[56px] sm:text-[72px] font-bold leading-none tracking-tight text-[var(--c-ink)]">4.9</span>
              <div className="flex flex-col items-start gap-1.5">
                ...
                <p className="text-[10px] tracking-[0.2em] text-[var(--c-ink-3)] uppercase">Verified Reviews</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-5">
              {([
                ...
                <div key={label} className="flex items-center gap-4">
                  <span className="text-[11px] tracking-[0.08em] text-[var(--c-ink-2)] w-[148px] shrink-0">{label}</span>
                  ...
                  <span className="text-[11px] font-semibold text-[var(--c-ink)] w-7 text-right tabular-nums">{score.toFixed(1)}</span>
                </div>
              ))}
            </div>
