...
const SECTIONS: Record<Lang, Section[]> = {
  ...
  ko: [
    {
      label: "사업자 명칭",
      blocks: [{ type: "text", value: "貝八方 주식회사 (Octoshell Co., Ltd.)" }],
    },
    {
      label: "대표자",
      blocks: [{ type: "text", value: "대표이사　염 뇌뢰 (Lei-Lei Ran)" }],
    },
    {
      label: "운영 책임자",
      blocks: [{ type: "text", value: "Tracy Chen" }],
    ...
    {
      label: "본사 소재지",
      blocks: [{ type: "text", value: "〒271-0064　지바현 마쓰도시 가미혼고 618번지의 1　마쓰도 제8맨션 103호" }],
    },
    {
      label: "연락처",
      blocks: [{ type: "dl", pairs: [
        ["전화번호",       "047-382-5728"],
        ["전화 응대 시간", "10:00~17:00 (연중무휴)"],
        ["이메일 주소",   "info@octoshell.jp"],
        ["웹사이트 URL",  "https://octoshell.jp"],
      ]}],
    },
    {
      label: "서비스 내용",
      blocks: [{ type: "text", value: "일반 승용 여객 자동차 운송사업 (하이어·고급 의전 서비스) 제공." }],
    },
    {
      label: "판매 가격",
      blocks: [
        { type: "text", value: "각 서비스의 제안서, 견적 화면 또는 예약 페이지에 기재된 금액 (소비세 포함)." },
        { type: "note", value: "당사가 제시하는 견적 금액에는 통상 운행에 필요한 고속도로 요금, 유료도로 요금, 회송 통행료, 주차비 및 드라이버 숙박비 (원거리·숙박이 있는 경우)가 모두 포함되어 있습니다." },
      ],
    },
    {
      label: "상품 대금 외 필요 요금",
      blocks: [{ type: "dl", pairs: [
        ["돌발적 추가 비용", "운행 개시 후 고객의 요청에 의해 당초 예정에 없던 경로 변경, 경유지 추가 또는 이용 시간 연장이 발생한 경우에 한해, 이로 인해 새롭게 발생하는 고속도로 요금, 유료도로 요금, 회송 통행료, 주차비, 드라이버 숙박비 및 시간 연장 할증료를 별도 청구합니다."],
        ["통신료 등",         "당 사이트 열람, 온라인 예약·결제 시 발생하는 인터넷 접속료 및 통신료."],
        ["계좌이체 수수료",   "계좌이체로 결제하실 경우 발생하는 은행 수수료."],
      ]}],
    },
    {
      label: "결제 수단",
      blocks: [{ type: "list", items: [
        "신용카드 결제 (Visa, Mastercard, American Express, JCB, Diners Club, Discover) ※전용 온라인 결제 시스템 경유",
        "계좌이체 (사전 입금)",
        "현금 결제 (하차 시 정산)",
      ]}],
    },
    {
      label: "결제 시기",
      blocks: [{ type: "dl", pairs: [
        ["신용카드 결제", "예약 확정 시 즉시 결제, 또는 사전 발송된 결제 링크를 통한 결제."],
        ["계좌이체",     "이용일 전날(또는 별도 지정 기일)까지 사전 입금."],
        ["현금 결제",    "서비스 종료(하차) 시 드라이버에게 직접 정산."],
      ]}],
    },
    {
      label: "서비스 제공 시기",
      blocks: [{ type: "text", value: "예약 시 또는 최종 확정서(배차 지시서·일정표)에 지정된 일시에 지정 장소로 차량을 배차하여 서비스를 제공합니다." }],
    },
    {
      label: "취소·변경·환불에 관하여",
      blocks: [
        { type: "text", value: "서비스 특성상 배차 후의 환불·변경은 불가합니다. 취소의 경우 아래 규정에 따라 취소 수수료를 부과합니다." },
        { type: "list", items: [
          "배차일 48시간 전까지: 무료 (전액 환불)",
          "배차일 24시간 전~48시간 전: 견적 금액의 50%",
          "배차일 24시간 이내 또는 무단 취소: 견적 금액의 100%",
        ]},
        { type: "note", value: "항공편 결항 등 불가항력의 경우, 즉시 연락 주시면 취소 수수료가 면제됩니다." },
      ],
    },
    {
      label: "인허가 표시",
      blocks: [{ type: "dl-stacked", pairs: [
        ["일반 승용 여객 자동차 운송사업 (하이어) 허가", "관자여이제 1248호 (관동 운수국장 인가)"],
        ["운임 및 요금 인가",                           "관자여이제 388호 / 기한 변경 통지 관자여이제 773호"],
      ]}],
    },
  ],
};
