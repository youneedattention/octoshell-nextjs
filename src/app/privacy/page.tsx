  ...
  ko: [
    {
      heading: "개인정보의 정의",
      blocks: [
        { type: "text", value: "본 방침에서 개인정보란 성명, 주소, 이메일 주소, 접속 기록, 기타 기술 내용, 개인에게 부여된 번호·기호, 이미지 또는 음성 등 특정 개인을 직접 또는 간접적으로 식별할 수 있는 모든 정보를 말합니다(단독으로는 식별 불가하더라도 다른 데이터와 쉽게 대조하여 식별 가능한 것을 포함합니다)." },
      ],
    },
    {
      heading: "개인정보의 이용 목적 범위",
      blocks: [
        { type: "text", value: "당사가 개인정보를 수집·이용하는 목적은 다음과 같습니다." },
        { type: "list", items: [
          "당사, 제휴 파트너 및 공동 운행 회사가 인터넷을 통해 '하이어 예약' 업무를 완수하기 위해.",
          "고객이 웹사이트에서 개인화·최적화된 정보를 열람할 수 있도록 하기 위해.",
          "등록 내용을 바탕으로 당사가 고객에게 유익한 정보를 제공하기 위해.",
        ]},
      ],
    },
    {
      heading: "제3자에 대한 개인정보 제공 제한",
      blocks: [
        { type: "text", value: "당사는 원칙적으로 고객의 사전 동의 없이 개인정보를 제3자에게 공개하거나 제공하지 않습니다. 수집된 개인정보는 당사, 본 웹사이트의 운영 관리 주체, 그리고 당사와 비밀유지 계약을 체결한 제휴 파트너 및 공동 운행 회사 간에서만 비공개로 엄격히 관리됩니다." },
        { type: "text", value: "또한 웹사이트의 운영 관리 및 운송·여행 업무의 일부를 당사와 비밀유지를 포함한 업무 위탁 계약을 체결한 기업 또는 개인에게 위탁하는 경우가 있습니다." },
        { type: "note", label: "【단, 다음과 같은 예외적인 상황에서 개인정보를 제공할 수 있습니다】", body: "고객의 행위가 제3자에게 불이익을 초래한다고 당사가 판단할 경우, 해당 제3자·경찰 또는 관련 기관에 통보할 수 있습니다. 또한 법원, 검찰청, 경찰, 변호사회, 소비자보호원 또는 기타 공공·준공공기관으로부터 합법적인 절차에 따른 정보 제공 요청이 있을 경우 이에 응합니다. 당사의 권리 및 재산 보호를 위해 필요한 경우에도 정보를 제공할 권리를 보유합니다." },
        { type: "text", value: "당사는 잠재적인 제휴 파트너, 광고주 및 기타 제3자에게 당사 서비스를 설명하는 목적 또는 기타 합법적인 목적으로 고객의 통계 정보(개인을 특정할 수 없는 정보)를 공개할 수 있습니다." },
      ],
    },
    {
      heading: "무단 컴퓨터 접근에 대한 대응 조치",
      blocks: [
        { type: "text", value: "당사는 개인정보에 대한 무단 접근, 분실, 파괴, 변조 및 유출을 방지하기 위해 적절한 조직적·기술적 보안 대책 및 관리 조치를 시행합니다." },
      ],
    },
    {
      heading: "인터넷상의 개인정보 보호 주의 사항",
      blocks: [
        { type: "text", value: "인터넷상에서 자발적으로 개인정보를 공개한 경우, 해당 정보가 다른 이용자에 의해 수집·이용될 수 있다는 점에 유의하시기 바랍니다. 누구나 접근 가능한 공개 공간에 개인정보를 게시하면 이를 기반으로 한 원치 않는 메시지를 받을 수 있습니다." },
        { type: "text", value: "고객은 본인의 책임 아래 정보를 전송하시기 바랍니다. 또한 본 웹사이트를 통해 데이터를 수집하거나 독립적인 서비스·혜택·판매 인센티브를 제공하는 외부 제3자 기업은 각자의 개인정보 규정을 보유합니다. 당사는 당사 웹사이트와 독립적인 이들 외부 규정 및 활동에 대해 어떠한 의무나 책임도 지지 않습니다." },
      ],
    },
  ],
