                ...
                <ul className="flex flex-col gap-2.5">
                  ...
                  <li>
                    <Link href={`/book`} className="group inline-flex items-center gap-3">
                      ...
                      <span className="flex flex-col">
                        <span className="text-white/70 group-hover:text-[#c9a84c] group-active:text-[#c9a84c] text-[13px] font-semibold leading-tight transition-colors duration-200">{t.footer_webapp[lang]}</span>
                        <span className="text-white/30 group-hover:text-[#c9a84c]/60 group-active:text-[#c9a84c]/60 text-[11px] tracking-[0.04em] transition-colors duration-200">{t.footer_webapp_sub[lang]}</span>
                      </span>
                    </Link>
                  </li>
                  ...
                  <li>
                    <button type="button" onClick={() => window.open("https://wa.me/19716665151", "_blank", "noopener,noreferrer")}
                      ...
                      <span className="flex flex-col">
                        <span className="text-white/70 group-hover:text-[#c9a84c] group-active:text-[#c9a84c] text-[13px] font-semibold leading-tight transition-colors duration-200">{t.footer_whatsapp[lang]}</span>
                        <span className="text-white/30 group-hover:text-[#c9a84c]/60 group-active:text-[#c9a84c]/60 text-[11px] tracking-[0.04em] transition-colors duration-200">{t.footer_whatsapp_sub[lang]}</span>
                      </span>
                    </button>
                  </li>
                    ...
                    <ObfuscatedEmail
                      ...
                      customContent={
                        <>
                          ...
                          <span className="flex flex-col">
                            <span className="text-white/70 group-hover:text-[#c9a84c] group-active:text-[#c9a84c] text-[13px] font-semibold leading-tight transition-colors duration-200">{t.footer_email[lang]}</span>
                            <span className="text-white/30 group-hover:text-[#c9a84c]/60 group-active:text-[#c9a84c]/60 text-[11px] tracking-[0.04em] transition-colors duration-200">{t.footer_email_sub[lang]}</span>
                          </span>
                        </>
                      }
                    />
