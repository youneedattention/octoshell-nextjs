            ...
            <div className="hidden lg:flex flex-col">
              ...
              <div className="mt-8 ml-4 pt-6 border-t border-[var(--c-rule)]">
                ...
                <ul className="flex flex-col gap-2.5">
                  ...
                  {/* Reserve Online */}
                  <li>
                    <Link href={`/book`} className="group inline-flex items-center gap-3">
                      <span className="flex-shrink-0 w-[25px] h-[25px] rounded-full bg-[var(--c-rule)] group-hover:bg-[#c9a84c] group-active:bg-[#c9a84c] flex items-center justify-center transition-colors duration-200">
                        <svg viewBox="0 0 24 24" className="w-[13px] h-[13px] text-[var(--c-ink-4)] group-hover:text-white group-active:text-white transition-colors duration-200" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
                          <rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4M8 2v4M3 10h18" />
                        </svg>
                      </span>
                      <span className="flex flex-col">
                        <span className="text-[var(--c-ink-3)] group-hover:text-[#c9a84c] group-active:text-[#c9a84c] text-[13px] font-semibold leading-tight transition-colors duration-200">{t.footer_webapp[lang]}</span>
                        <span className="text-[var(--c-ink-4)] group-hover:text-[#c9a84c]/60 group-active:text-[#c9a84c]/60 text-[11px] tracking-[0.04em] transition-colors duration-200">{t.footer_webapp_sub[lang]}</span>
                      </span>
                    </Link>
                  </li>

                  <li><div className="h-px bg-[var(--c-rule)]" /></li>

                  {/* WhatsApp */}
                  <li>
                    <button type="button" onClick={() => window.open("https://wa.me/19716665151", "_blank", "noopener,noreferrer")}
                      className="group inline-flex items-center gap-3 cursor-pointer w-full text-left">
                      <span className="flex-shrink-0 w-[25px] h-[25px] rounded-full bg-[var(--c-rule)] group-hover:bg-[#c9a84c] group-active:bg-[#c9a84c] flex items-center justify-center transition-colors duration-200">
                        <svg viewBox="0 0 24 24" className="w-[14px] h-[14px] fill-[var(--c-ink-4)] group-hover:fill-white group-active:fill-white transition-colors duration-200">
                      ...
                      <span className="flex flex-col">
                        <span className="text-[var(--c-ink-3)] group-hover:text-[#c9a84c] group-active:text-[#c9a84c] text-[13px] font-semibold leading-tight transition-colors duration-200">{t.footer_whatsapp[lang]}</span>
                        <span className="text-[var(--c-ink-4)] group-hover:text-[#c9a84c]/60 group-active:text-[#c9a84c]/60 text-[11px] tracking-[0.04em] transition-colors duration-200">{t.footer_whatsapp_sub[lang]}</span>
                      </span>
                    </button>
                  </li>
                  ...
                  <li>
                    <ObfuscatedEmail
                      ...
                      customContent={
                        <>
                          <span className="flex-shrink-0 w-[25px] h-[25px] rounded-full bg-[var(--c-rule)] group-hover:bg-[#c9a84c] group-active:bg-[#c9a84c] flex items-center justify-center transition-colors duration-200">
                            <svg viewBox="0 0 24 24" className="w-[13px] h-[13px] text-[var(--c-ink-4)] group-hover:text-white group-active:text-white transition-colors duration-200" fill="none" stroke="currentColor" strokeWidth={1.8}>
                              <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                            </svg>
                          </span>
                          <span className="flex flex-col">
                            <span className="text-[var(--c-ink-3)] group-hover:text-[#c9a84c] group-active:text-[#c9a84c] text-[13px] font-semibold leading-tight transition-colors duration-200">{t.footer_email[lang]}</span>
                            <span className="text-[var(--c-ink-4)] group-hover:text-[#c9a84c]/60 group-active:text-[#c9a84c]/60 text-[11px] tracking-[0.04em] transition-colors duration-200">{t.footer_email_sub[lang]}</span>
                          </span>
                        </>
                      }
                    />
