  ...
  return (
    <header ref={headerRef} className="fixed top-0 inset-x-0 z-50">
      ...
      <div className={`transition-all duration-300
        ...
        {/* ── DESKTOP: Split Nav grid [left nav | logo | right nav + controls] ── */}
        <div className="hidden sm:grid sm:h-[84px]"
             style={{ gridTemplateColumns: "1fr auto 1fr" }}>

          {/* LEFT: nav links — right-aligned */}
          ...
          <div className="flex items-center justify-center px-6 lg:px-8">
            <Link href={lp("/")} draggable={false} onContextMenu={(e) => e.preventDefault()}
              ...
              <ProtectedImage src={LOGO} alt="Octoshell" width={72} height={72} draggable={false}
                className="object-contain drop-shadow-lg pointer-events-none select-none" />
            </Link>
          </div>

          {/* RIGHT: nav links + controls — left-aligned */}
          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <button
              ...
              className="flex text-white/60 hover:text-white/95 items-center transition-colors duration-150"
            >
